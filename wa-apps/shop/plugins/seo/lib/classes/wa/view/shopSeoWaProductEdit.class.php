...
class shopSeoWaProductEdit
{
	...
	public function getState($product_id)
	{
		...
		return array(
			...
			'groups_storefronts' => $this->getGroupsStorefronts($product_id),
	...
	private function getGroupsStorefronts($product_id)
	{
		...
		foreach ($groups_storefronts as $group_storefront) {
			...
			$group_storefront_mapped['have_personal_value'] = $this->product_settings_service->havePersonal($group_storefront->getId(), $product_id);
