	...
	shopSeoBrandDataSource, shopSeoProductDataSource
{
	...
	public function getCategoryProductsData($storefront, $category_id)
	{
		...
		if ($this->plugin_settings_service->getSettings()->cache_is_enabled)
		{
			...
			if (!array_key_exists($key, $data)) {
				$data[$key] = $this->fetchCategoryProductsData($category_id, $default_currency, $frontend_currency);
				$cache->set($data);
			}
		...
		return $this->fetchCategoryProductsData($category_id, $default_currency, $frontend_currency);
	}
	...
	private function fetchCategoryProductsData($category_id, $default_currency, $frontend_currency)
	{
